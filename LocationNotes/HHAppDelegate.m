...
{
//    if (![self checkIfAlreadyRegistered:note]) {
...
//                                              inManagedObjectContext:self.managedObjectContext];
//    fetchRequest.predicate = [NSPredicate predicateWithFormat:@"noteTitle == %@ AND noteDescription == %@ AND noteComment == %@ AND noteLongitude == %@ AND noteLatitude == %@", note.noteTitle, note.noteDescription, note.noteComment, note.noteLongitude, note.noteLatitude];
...
{
    Note *noteToDelete = [[Note alloc] init];
    noteToDelete.noteTitle = note.noteTitle;
    noteToDelete.noteDescription = note.noteDescription;
    noteToDelete.noteComment = note.noteComment;
    noteToDelete.noteLatitude = [NSNumber numberWithFloat:note.noteLatitude];
    noteToDelete.noteLongitude = [NSNumber numberWithFloat:note.noteLongitude];
